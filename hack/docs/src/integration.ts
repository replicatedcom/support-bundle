...
// this is some weird E2E testing for making sure the examples we put in
// the docs actually generate the files we say they do.
// Its jank and kinda WIP still. I don't intend for this to replace the ginkgo e2e testing

...
func assetsConfigmanagementYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/configManagement.yml", size: 1215, mode: os.FileMode(420), modTime: time.Unix(1555442643, 0)}
